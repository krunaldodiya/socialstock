...
const data = {
  labels: ["20⏱️", "25⏱️", "30⏱️", "35⏱️", "40⏱️", "45⏱️", "50⏱️", "55⏱️", "60⏱️"],
  datasets: [
    {
...
const BoxComponent = (props: any) => {
	return (
		<View style={styles.box}>
			...
			{props.gold == "1" && <Image source={images.trophy1} style={styles.trophy} />}
      {props.gold == "2" && <Image source={images.trophy2} style={styles.trophy} />}
			{props.gold == "3" && <Image source={images.trophy3} style={styles.trophy} />}
