				...
				<View>
					...
					<View style={styles.boxView}>
						<View style={styles.box}>
							<FontAwesome name="heart" size={16} color={'#e64c3c'} style={{ marginTop: -12 }} />
						...
						<View style={styles.box2}>
							<FontAwesome name="comment-o" size={16} color={'#b4b2b2'} style={{ marginTop: -12 }} />
							<View style={{ marginLeft: 12 }}>
						...
						<View style={[ styles.box, { justifyContent: 'flex-end' } ]}>
							<Ionicons name="ios-refresh" size={16} color={'#b4b2b2'} style={{ marginTop: -12 }} />
							<View style={{ marginLeft: 12 }}>
