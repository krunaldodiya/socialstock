...
const data = {
  ...
  datasets: [
        images.india, images.us, images.spain, images.russia
  ]
};
...
function renderItem(){
    ...
    for( let i = 0 ; i < len ; i++ ){
        ListArr.push(
        <BoxComponent gold = {i}></BoxComponent>
        );
    }
    return ListArr;
}
	...
	return (
		<View style={styles.box}>
			<View style={{ flexDirection: 'row', alignItems:'center' }}>
                ...
                >
                    <TouchableOpacity style = {bClick ? styles.rightArrowActive : styles.rightArrow} >
                        <MaterialIcons name="keyboard-arrow-right" size={20} color={bClick ? '#519FF8' : '#fff'} />
                    </TouchableOpacity>
                </LinearGradient>
			</View>
		</View>
